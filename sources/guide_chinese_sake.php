...
<body>
    ...
    <main>
        <div class="container">
            <!-- ヒーローセクション -->
            <section class="sake-hero" style="background-image: url('img/chinese_lantern.png');">
                <div class="sake-hero__inner">
                    <h2 class="sake-hero__title">中国酒の世界へようこそ</h2>
                    <p class="sake-hero__subtitle">悠久の歴史と多様な香り</p>
                </div>
            </section>
                ...
                <div class="section-inner">
                    ...
                    <div class="sake-intro-content">
                        <div class="sake-intro-content__image-container">
                            <img src="img/国花瓷.png" alt="中国酒の紹介画像" class="sake-intro-content__image">
            ...
            <section class="sake-section sake-beginner-types">
                <div class="section-inner">
                    ...
                    <div class="sake-types">
                        ...
                        <div class="sake-type-card sake-type-card--bg" style="background-image: url('img/shaoxing_wine.png');">
                            <h4>黄酒（ホアンチュウ）</h4>
            ...
            <section class="sake-section recommended-sake">
                <div class="section-inner">
                    ...
                    <a href="products_list.php?category=chinese_sake" class="btn-view-all">中国酒一覧を見る</a>
                </div>
            </section>
        </div>
    </main>
